...
ORDER_TABLE = 'OrderDB'
PRODUCT_ORDER_QUEUE = ''
SAMSUNG_QUEUE = 'https://sqs.eu-north-1.amazonaws.com/706824313294/samsungOrderQueue'
SHIPPING_QUEUE = 'https://sqs.eu-north-1.amazonaws.com/706824313294/shippingOrderQueue'
ORDER_STATUS_NEXT = "InProgress-Shipping"
...
def lambda_handler(event, context):
    ...
    try:
        ...
        for record in event['Records']:
            ...
            #
            emailMessage = "Dear " + customerName + " \n\n\nYou order progressed and ready for Shipping. \n.\n\nThank You\nsavitasingh.shop"
            subject = "Order : " + orderId + "Order Status - OrderComplete"
